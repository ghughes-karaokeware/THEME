...
- `CHUI_FONT` opens a conventional Windows font popup with installed faces, style selection, effects, and preview while omitting font size. Its `Face name|style mask` value directly preserves CDE style flags outside Bold/Italic/Underline, and remains transactional under Apply/OK/Cancel.
